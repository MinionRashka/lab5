...
public class CommandShell {
    public CommandShell() {}
    public LinkedHashMap<Integer, HumanBeing> Analyze(HumanList humanList, LinkedHashMap<Integer, HumanBeing> human, String command, String path, boolean b) {
        ...
        commandList.put("clean", new Clean(human, command, humanList));
